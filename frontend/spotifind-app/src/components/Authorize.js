...
const Authorize = (props) => {
  ...
  return (
    <div className="flex items-center justify-center static left-0 my-20">
      <div className="w-full rounded-md bg-white shadow dark:border sm:max-w-lg xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          ...
          <form onSubmit={authorizeSubmit}>
            <div>
              ...
              <p className="block mb-5 text-sm font-medium text-gray-900 dark:text-white">
                Looks like your Spotifind hasn't connected to your spotify.
                Click the button below to authorize spotify to access your
                playlists:{" "}
              </p>
              <input
                type="submit"
